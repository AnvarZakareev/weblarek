...
function showModal() {
  modalContainer.style.display = 'flex'; // или 'flex'
}
...
const newCard = new CardCatalog(newcardElement, {
  ...
  newCard.image = 'src/images/logo.svg';
  newCard.title = 'card.title';
  newCard.price = 99999999999999999 as number;

const element = newCard.render() as HTMLElement;

arrayCard2.push(element);

// gallery.catalog = [...arrayCard, ...arrayCard2];
...
//   cardPre.image = "no";
//   cardPre.category = 'Any';
//   cardPre.description = 'many';
  
//   const elementPreview = cardPre.render() as HTMLElement

//   const modal = new Modal(events, elementPreview);
